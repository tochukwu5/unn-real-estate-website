  ...
  return (
    <header>
      ...
      {mobileMenuOpen && (
        ...
        >
          <Box sx={menuStyle} p={2} onClick={() => navigateMobile("/")}>
            Home
          </Box>
          <Box sx={menuStyle} p={2} onClick={() => navigateMobile("/about")}>
            About
          </Box>
          {avatar ? (
            <>
              <Box sx={menuStyle} p={2} onClick={() => navigateMobile("/listings")}>
                Listings
              </Box>
              <Box
                sx={menuStyle}
                p={2}
                onClick={() => navigateMobile("/create-listing")}
              >
                Create Listing
              </Box>
              <Box p={2} onClick={() => navigateMobile("/profile")}>
                Profile
              </Box>
              <Box
                p={2}
            ...
            <Box sx={menuStyle} p={2} onClick={() => navigateMobile("/login")}>
              Log in
            </Box>
          )}
        </Box>
